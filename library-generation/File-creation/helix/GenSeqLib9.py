...
fragfile = open("/mnt/pspdata/.init/frag-helix/sol/9fragfile", "a+")
errfile = open("/mnt/pspdata/.init/frag-helix/sol/9errfile", "a+")

for file in os.listdir('/mnt/pspdata/.init/frag-helix/9frag/'):
	try:
	    f= open('/mnt/pspdata/.init/frag-helix/9frag/'+file,"r")
