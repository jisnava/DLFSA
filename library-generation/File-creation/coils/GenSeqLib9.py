...
fragfile = open("/mnt/pspdata/.init/frag-coils/sol/9fragfile", "a+")
errfile = open("/mnt/pspdata/.init/frag-coils/sol/9errfile", "a+")

for file in os.listdir('/mnt/pspdata/.init/frag-coils/9frag/'):
	try:
	    f= open('/mnt/pspdata/.init/frag-coils/9frag/'+file,"r")
