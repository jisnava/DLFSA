...
fragfile = open("/mnt/pspdata/.init/frag-sheet/sol/3fragfile", "a+")
errfile = open("/mnt/pspdata/.init/frag-sheet/sol/3errfile", "a+")

for file in os.listdir('/mnt/pspdata/.init/frag-sheet/3frag/'):
	try:
	    f= open('/mnt/pspdata/.init/frag-sheet/3frag/'+file,"r")
