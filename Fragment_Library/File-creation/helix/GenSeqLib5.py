...
fragfile = open("/mnt/pspdata/.init/frag-helix/sol/5fragfile", "a+")
errfile = open("/mnt/pspdata/.init/frag-helix/sol/5errfile", "a+")

for file in os.listdir('/mnt/pspdata/.init/frag-helix/5frag/'):
	try:
	    f= open('/mnt/pspdata/.init/frag-helix/5frag/'+file,"r")
