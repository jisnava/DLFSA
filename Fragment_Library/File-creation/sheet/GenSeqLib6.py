...
fragfile = open("/mnt/pspdata/.init/frag-sheet/sol/6fragfile", "a+")
errfile = open("/mnt/pspdata/.init/frag-sheet/sol/6errfile", "a+")

for file in os.listdir('/mnt/pspdata/.init/frag-sheet/6frag/'):
	try:
	    f= open('/mnt/pspdata/.init/frag-sheet/6frag/'+file,"r")
