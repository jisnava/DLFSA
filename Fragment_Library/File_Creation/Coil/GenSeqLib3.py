...
fragfile = open("/mnt/pspdata/.init/frag-coils/sol/3fragfile", "a+")
errfile = open("/mnt/pspdata/.init/frag-coils/sol/3errfile", "a+")

for file in os.listdir('/mnt/pspdata/.init/frag-coils/3frag/'):
	try:
	    f= open('/mnt/pspdata/.init/frag-coils/3frag/'+file,"r")
