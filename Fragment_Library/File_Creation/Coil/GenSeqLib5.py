...
fragfile = open("/mnt/pspdata/.init/frag-coils/sol/5fragfile", "a+")
errfile = open("/mnt/pspdata/.init/frag-coils/sol/5errfile", "a+")

for file in os.listdir('/mnt/pspdata/.init/frag-coils/5frag/'):
	try:
	    f= open('/mnt/pspdata/.init/frag-coils/5frag/'+file,"r")
