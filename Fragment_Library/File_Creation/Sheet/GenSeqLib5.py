...
fragfile = open("/mnt/pspdata/.init/frag-sheet/sol/5fragfile", "a+")
errfile = open("/mnt/pspdata/.init/frag-sheet/sol/5errfile", "a+")

for file in os.listdir('/mnt/pspdata/.init/frag-sheet/5frag/'):
	try:
	    f= open('/mnt/pspdata/.init/frag-sheet/5frag/'+file,"r")
