...
fragfile = open("/mnt/pspdata/.init/frag-helix/sol/6fragfile", "a+")
errfile = open("/mnt/pspdata/.init/frag-helix/sol/6errfile", "a+")

for file in os.listdir('/mnt/pspdata/.init/frag-helix/6frag/'):
	try:
	    f= open('/mnt/pspdata/.init/frag-helix/6frag/'+file,"r")
